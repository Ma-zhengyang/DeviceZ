...
import com.android.mazhengyang.device_z.fragments.ToolTorchFragment;
...
public class CompassView extends View {
    ...
    private void drawText() {
        if (val <= 15 || val >= 345) {
            text = mContext.getString(R.string.north);
        } else if (val > 15 && val <= 75) {
            text = mContext.getString(R.string.northeast);
        } else if (val > 75 && val <= 105) {
            text = mContext.getString(R.string.east);
        } else if (val > 105 && val <= 165) {
            text = mContext.getString(R.string.southeast);
        } else if (val > 165 && val <= 195) {
            text = mContext.getString(R.string.south);
        } else if (val > 195 && val <= 255) {
            text = mContext.getString(R.string.southwest);
        } else if (val > 255 && val <= 285) {
            text = mContext.getString(R.string.west);
        } else if (val > 285 && val < 345) {
            text = mContext.getString(R.string.northwest);
        }
